...
class Business(Model):
    ...
    city = fields.CharField(max_length=75, null=False, default="Unspecified")
    region = fields.CharField(max_length=75, null=False, default="Unspecified")
    business_description = fields.TextField(null = True)
    logo = fields.CharField(max_length=150, null=False, default="default.jpg")
    owner = fields.ForeignKeyField("models.User", related_name="business")
    
class Product(Model):
    id= fields.IntField(pk=True, index= True)
    product_name = fields.CharField(max_length=100, null=False, unique=True)
...
busines_pydantic = pydantic_model_creator(Business, name="Business")
